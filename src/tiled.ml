...
let parse_room_filename source file_name : area_id * room_id =
  ...
  | "ac-repair_e" -> (AC_REPAIR_ANNEX, FC_A)
  | "ac-repair_f" -> (AC_REPAIR_ANNEX, FC_A)
  | "basement_a" -> (BASEMENT, FC_A)
  | "basement_abyss-climb" -> (BASEMENT, FC_A)
  | "basement_b" -> (BASEMENT, FC_A)
  | "basement_c" -> (BASEMENT, FC_A)
  | "basement_d" -> (BASEMENT, FC_A)
  | "basement_e" -> (BASEMENT, FC_A)
  | "beenz_a" -> (MEOW_MEOW_BEENZ, FC_A)
  | "city_a" -> (CITY_OF_CHAIRS, FC_A)
  | "city_b" -> (CITY_OF_CHAIRS, FC_A)
  | "city_d" -> (CITY_OF_CHAIRS, FC_A)
  | "city_e" -> (CITY_OF_CHAIRS, FC_A)
  | "computer_a" -> (COMPUTER_WING, FC_A)
  | "computer_b" -> (COMPUTER_WING, FC_A)
  | "computer_c" -> (COMPUTER_WING, FC_A)
  | "computer_f" -> (COMPUTER_WING, FC_A)
  | "computer_g" -> (COMPUTER_WING, FC_A)
  | "computer_h" -> (COMPUTER_WING, FC_A)
  | "computer_i" -> (COMPUTER_WING, FC_A)
  | "computer_k" -> (COMPUTER_WING, FC_A)
  | "computer_m" -> (COMPUTER_WING, FC_A)
  | "forgotten_a" -> (FORGOTTEN_CLASSROOMS, FC_A)
  | "forgotten_b" -> (FORGOTTEN_CLASSROOMS, FC_B)
  | "forgotten_c" -> (FORGOTTEN_CLASSROOMS, FC_C)
  | "forgotten_d" -> (FORGOTTEN_CLASSROOMS, FC_D)
  ...
  | "forgotten_h" -> (FORGOTTEN_CLASSROOMS, FC_H)
  | "forgotten_i" -> (FORGOTTEN_CLASSROOMS, FC_I)
  | "infected_a" -> (INFECTED_CLASSROOMS, FC_A)
  | "infected_b" -> (INFECTED_CLASSROOMS, FC_A)
  | "infected_c" -> (INFECTED_CLASSROOMS, FC_A)
  | "infected_d" -> (INFECTED_CLASSROOMS, FC_A)
  | "library_a" -> (LIBRARY, FC_A)
  | "library_b" -> (LIBRARY, FC_A)
  | "library_c" -> (LIBRARY, FC_A)
  | "library_d" -> (LIBRARY, FC_A)
  | "library_e" -> (LIBRARY, FC_A)
  | "library_f" -> (LIBRARY, FC_A)
  | "library_g" -> (LIBRARY, FC_A)
  | "library_h" -> (LIBRARY, FC_A)
  | "library_i" -> (LIBRARY, FC_A)
  | "outlands_a" -> (OUTLANDS, FC_A)
  | "outlands_b" -> (OUTLANDS, FC_A)
  | "outlands_c" -> (OUTLANDS, FC_A)
  | "outlands_d" -> (OUTLANDS, FC_A)
  | "outlands_e" -> (OUTLANDS, FC_A)
  | "trampoline_a" -> (TRAMPOLINEPATH, FC_A)
  | "trampoline_b" -> (TRAMPOLINEPATH, FC_A)
  | "trampoline_c" -> (TRAMPOLINEPATH, FC_A)
  | "trampoline_d" -> (TRAMPOLINEPATH, FC_A)
  | "trampoline_e" -> (TRAMPOLINEPATH, FC_A)
  | "trampoline_f" -> (TRAMPOLINEPATH, FC_A)
  | "trampoline_g" -> (TRAMPOLINEPATH, FC_A)
  | "trampoline_h" -> (TRAMPOLINEPATH, FC_A)
...
let init_world (path : string) : (room_id * room_location) list =
  ...
  let get_room_location (global_map : Json_t.global_map) : room_id * room_location =
    ...
    tmp "filename %s, room_location global x: %d, y: %d" filename global_map.x global_map.y;
    ( room_id,
      {
        filename;
